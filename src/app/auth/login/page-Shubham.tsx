          ...
          <div className="p-8">
            ...
            {otpSent ? (
              ...
              <form onSubmit={handleRequestOtp} className="space-y-4">
                ...
                {loginMethod === 'mobile' ? (
                  <div>
                    <label className="text-xs font-bold text-gray-555 mb-1.5 block">Mobile Number</label>
                    <div className="relative">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 px-4 hover:bg-gray-50 transition-colors font-medium text-gray-700 text-sm cursor-pointer"
            >
