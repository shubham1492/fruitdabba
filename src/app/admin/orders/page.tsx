        ...
        {['all', ...STATUSES].map((s) => (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors capitalize ${
              filter === s ? 'bg-forest text-white' : 'bg-white text-gray-600 hover:bg-gray-50 border border-gray-200'
            }`}
          >
            {s}
          </button>
        ...
        <table className="w-full">
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={6} className="text-center py-12 text-gray-400">No orders</td></tr>
            ) : orders.map((order) => (
