...
export default function SubscriptionCTA({ plans }: { plans: SubscriptionPlan[] }) {
  ...
  const fruitPlans = plans.filter(p => p.plan_type === 'fruits')
  const saladPlans = plans.filter(p => p.plan_type === 'salads')
  ...
  return (
    <section id="plans" className="pt-10 pb-16 sm:pt-14 sm:pb-20 bg-white">
